...
public class BookDetails extends AppCompatActivity {
    ...
    private static String url = "http://192.168.43.75/HAUHAU/show.php?id=";
        ...
        protected Void doInBackground(Void... voids) {
            ...
            if(jsonStr != null) {
                try {
                    ...
                    final String strTitle = jsonObj.getString("judul");
                    final String strSummary = jsonObj.getString("ringkasan");
                    final String strLocation = jsonObj.getString("posisi_barang");
